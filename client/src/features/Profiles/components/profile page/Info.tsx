// Chakra imports
import { Card, CardBody, CardHeader, Flex, Icon, Link, Text, useColorModeValue } from "@chakra-ui/react";
// Custom components
...
const Info:React.FC<Props> = ({ title, description, name, mobile, email, location,} : Props) => {
  // Chakra color mode
