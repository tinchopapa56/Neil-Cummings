...
{
    /// <inheritdoc />
    public partial class nuevaLIVECHAT2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActAtts", x => new { x.ActivityId, x.AppUserId });
                    table.ForeignKey(
                        name: "FK_ActAtts_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActAtts_AspNetUsers_AppUserId",
